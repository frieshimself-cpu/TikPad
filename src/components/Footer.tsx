  ...
  return (
    <footer className="mt-24 border-t border-line bg-card">
      <div className="grid gap-8 px-6 py-10 text-sm sm:px-10 md:grid-cols-3">
        <div>
          <div className="text-xs font-bold uppercase tracking-widest text-dim">FansPad</div>
        ...
        <nav className="flex flex-col gap-1 text-muted">
          ...
          <a href="https://github.com/frieshimself-cpu/FansPad" className="hover:text-fg" target="_blank" rel="noreferrer">GitHub</a>
        </nav>
      </div>
    </footer>
  );
