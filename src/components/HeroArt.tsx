    ...
    <div className="relative mx-auto h-[420px] w-full max-w-[460px]" aria-hidden>
      ...
      <div className="float-b absolute left-0 top-10 w-64 rounded-2xl border border-line bg-card p-4 shadow-[0_24px_60px_-30px_rgba(19,18,16,0.45)]">
        <div className="flex items-center gap-3">
          <span className="num flex h-11 w-11 items-center justify-center rounded-xl bg-fg text-xs font-bold text-white">LUNA</span>
          <div>
            <div className="font-bold">Luna Coin</div>
        ...
        <div className="mt-4 h-16 w-full">
          <svg viewBox="0 0 240 64" className="h-full w-full" preserveAspectRatio="none">
            ...
            <path d="M0 52 L30 46 L55 50 L80 34 L105 38 L130 22 L160 28 L190 12 L215 18 L240 4" fill="none" stroke="#db2777" strokeWidth="2.5" strokeLinejoin="round" />
          </svg>
        </div>
      ...
      <div className="float-a absolute right-0 top-40 w-72 rounded-2xl bg-fg p-5 text-white shadow-[0_30px_70px_-30px_rgba(19,18,16,0.7)]">
        <div className="flex items-center justify-between">
          ...
          <span className="rounded-full bg-[#fbcfe8] px-2 py-0.5 text-[11px] font-bold text-[#131210]">confirmed</span>
        </div>
        <div className="mt-4 flex items-center gap-3">
          <Avatar handle="lunavale" size={40} />
          <div>
            <div className="font-bold">@lunavale</div>
            <div className="num text-xs text-white/60">OnlyFans · 48K fans</div>
          </div>
        </div>
      ...
      <div className="float-c absolute left-2 top-[372px] rounded-full border border-line bg-card px-3 py-1.5 text-xs font-semibold shadow-md">
        ...
        Fees to onlyfans.com/lunavale via FansPad
      </div>
      <div className="float-c absolute right-8 top-2 rounded-full bg-[#fbcfe8] px-3 py-1.5 text-xs font-bold shadow-md [animation-delay:1.2s]">80% to the creator</div>
    </div>
  );
}
